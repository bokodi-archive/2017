...
import {ACTIVITY_ENTITY_FIGHT, STATE_ENTITY_ATTACK_MELEE, STATE_ENTITY_WALK} from "../config/constants.js";

export default class AttackMelee extends PathAction {
	...
	attack(entity, game) {
		...
		entity.state = STATE_ENTITY_ATTACK_MELEE;
		entity.victim = this.target;
